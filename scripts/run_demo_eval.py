...
from backend.file_handler import load_vectorstore, create_memory
...
# Add a demo case
case = {"question": "What is the topic of the document?", "expected_sources": ["MLT_Unit-1_Introduction[1].pdf"]}
print('Adding case...')
